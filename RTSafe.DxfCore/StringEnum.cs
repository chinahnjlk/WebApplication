...
namespace RTSafe.DxfCore
{
    ...
    public class StringEnum
    {
        ...
        public string GetStringValue(string valueName)
        {
            ...
            try
            {
               Enum type = (Enum) Enum.Parse(this.enumType, valueName,false);
        ...
        public IList GetListValues()
        {
            ...
            foreach (FieldInfo fi in this.enumType.GetFields())
            {
                ...
                if (attrs != null)
                    if (attrs.Length > 0)
                        values.Add(new DictionaryEntry(Convert.ChangeType(Enum.Parse(this.enumType, fi.Name,false), underlyingType, Thread.CurrentThread.CurrentCulture), attrs[0].Value));
            }
