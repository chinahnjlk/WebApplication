...
namespace RTSafe.DxfCore
{
    ...
    public class DxfDocument
    {
        ...
        private List<Entities.IEntityObject> shaps;
        ...
        private readonly Dictionary<object, object> addedObjects;
        ...
        /// <summary>
        /// 版本号 
        /// <see cref="DxfVersion">version</see>.
        /// </summary>
        ...
        /// Gets the <see cref="netDxf.Entities.Text">text</see> list.
        /// </summary>
        public ReadOnlyCollection<IEntityObject> Shaps
        {
            get { return this.shaps.AsReadOnly(); }
        }
        ...
        public List<Hatch> hatchs { get; set; }
    }
}